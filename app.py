...
st.title("🍽️ Hệ thống Order Nhà Hàng MR. TUYỀN NHÓM CHỦ ĐỀ 2 - Giảm 50% cho hoá đơn trên 1 triệu")
...
menu = {
    ...
    "Thức uống": {
        ...
        "Nước Suối": 10000, "Sinh tố Bơ": 45000, "Nước ép cam": 40000,"Trà đào cam xả": 50000,
...
with col2:
    ...
    if st.session_state.order_dict:
        ...
        giam_gia = (tam_tinh * 5) if tam_tinh > 1000000 else 0
